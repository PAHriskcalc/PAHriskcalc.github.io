...
//RV Failure
const RV_Fail = {
	name: "RVFail", id: "RVFail", group: "Sympt", meta_group: "Clinical",
	weight: [1, 0, 0, 0], weight_f: [0, 0], value: [1, 0, 3],
...
const Sympt_Prog = {
	name: "SymptProg", id: "SymptProg", group: "Sympt", meta_group: "Clinical",
	weight: [1, 0, 0, 0], weight_f: [0, 0], value: [1, 2, 3],
...
// Syncope
const Syncope = {
	name: "Syncope", id: "Sycope", group: "Sympt", meta_group: "Clinical",
	weight: [1, 0, 0, 0], weight_f: [0, 0], value: [1, 2, 3],
...
// WHO-FC
const WHO_FC = {
	name: "WHO_FC", id: "WHO_FC", group: "WHO_walk", meta_group: "Modifiable",
	weight: [1, 1, 1, 2], weight_f: [1, 1], value: [1, 2, 3],
...
// 6MWT
const MWT = {
	name: "MWT", id: "MWT", group: "WHO_walk", meta_group: "Modifiable",
	weight: [1, 1, 1, 1], weight_f: [1, 1], value: [1, 2, 3],
...
// Peak VO_2
const Peak_VO2 = {
	name: "Peak_VO2", id: "PeakVO2", group: "Cardiopulmonary", meta_group: "Modifiable",
	weight: [1, 0, 0, 0], weight_f: [0, 0], value: [1, 2, 3],
...
// VE / VO_2 slope
const VE_slope = {
	name: "VE_slope", id: "VESlope", group: "Cardiopulmonary", meta_group: "Modifiable",
	weight: [1, 0, 0, 0], weight_f: [0, 0], value: [1, 2, 3],
	title: "VE/VO<sub>2</sub>-slope", btnText: ["VE/VO<sub>2</sub>-slope &nbsp;< 36", "VE/VO<sub>2</sub>-slope 36-44.9", "VE/VO<sub>2</sub>-slope &nbsp;&GreaterEqual; 45"],
	title_m: "VE/VO<sub>2</sub>-slope", btnText_m: ["< 36", "36-44.9", "&GreaterEqual; 45"],
...
// RAarea
const RAarea = {
	name: "RAarea", id: "RAarea", group: "Imaging", meta_group: "Modifiable",
	weight: [1, 0, 1, 0], weight_f: [0, 0], value: [1, 2, 3],
...
// sPAP
const sPAP = {
	name: "sPAP", id: "sPAP", group: "Imaging", meta_group: "Modifiable",
	weight: [1, 0, 0, 0], weight_f: [0, 0], value: [1, 2, 3],
...
const Pericardial_Effusion = {
	name: "Pericardial_Effusion", id: "PeriEff", meta_group: "Modifiable", group: "Imaging",
	weight: [1, 0, 1, 0], weight_f: [0, 0], value: [1, 2, 3],
...
// RVEF
const RVEF = {
	name: "RVEF", id: "RVEF", group: "cMRI", meta_group: "Modifiable",
	weight: [1, 0, 0, 0], weight_f: [0, 0], value: [1, 2, 3],
...
// SVI
const SVI_MRI = {
	name: "SVI_MRI", id: "SVI_MRI", group: "cMRI", meta_group: "Modifiable",
	weight: [1, 0, 0, 0], weight_f: [0, 0], value: [1, 2, 3],
...
// RVESVI
const RVESVI = {
	name: "RVESVI", id: "RVESVI", group: "cMRI", meta_group: "Modifiable",
	weight: [1, 0, 0, 0], weight_f: [0, 0], value: [1, 2, 3],
...
// MRAP
const MRAP = {
	name: "MRAP", id: "MRAP", group: "Haemodynamics", meta_group: "Modifiable",
	weight: [1, 1, 1, 0], weight_f: [1, 0], value: [1, 2, 3],
...
// CI
const CI = {
	name: "CI", id: "CI", group: "Haemodynamics", meta_group: "Modifiable",
	weight: [1, 1, 1, 0], weight_f: [1, 0], value: [1, 2, 3],
...
// SVI
const SVI = {
	name: "SVI", id: "SVI", group: "Haemodynamics", meta_group: "Modifiable",
	weight: [1, 0, 0, 0], weight_f: [0, 0], value: [1, 2, 3],
...
// SvO2
const SvO2 = {
	name: "SvO2", id: "SvO2", group: "Haemodynamics", meta_group: "Modifiable",
	weight: [1, 1, 1, 0], weight_f: [0, 0], value: [1, 2, 3],
...
// Check if we are using mobile or desktop table
var mobile_table = false;
...
function updateRisk() {
	...
	for (let i = 0; i < numOfRisks; i++) {
		...
		if (riskValue[i] && paramCount[i] >= paramMin) {
			var riskRate = ["&nbsp;<small>(Low)</small>", "&nbsp;<small>(Interm.-Low)</small>", "&nbsp;<small>(Interm.-High)</small>", "&nbsp;<small>(High)</small>"];
			if (mobile_table) {
				riskRate = ["<br><small>(Low)</small>", "<br><small>(Interm.-Low)</small>", "<br><small>(Interm.-High)</small>", "<br><small>(High)</small>"];
			}
			if (riskValue[i] < 1.5) {
...
function updateRisk_f() {
	...
	for (let i = 0; i < numOfRisks_f; i++) {
		...
		for (let j = 0; j < numOfParams; j++) {
			param_name = params[j].name;
			value = testValue.get(param_name);
			if (params[j].weight_f[i] && !paramSet.has(param_name)) {
				sum[i] += (value == 1);
				paramCount[i] += !Number.isNaN(value) * (params[j].weight_f[i] != 0);
			}
			if (params[j].weight_f[i] != 0) {
				paramSet.add(param_name);
			}
		}
		paramTotal[i] = paramSet.size;
