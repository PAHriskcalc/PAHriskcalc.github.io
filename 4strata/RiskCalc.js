...
const WHO_FC = {
	...
	weight: [1], weight_f: [1, 1], value: [1, 0, 3, 4],
...
const MWT = {
	...
	weight: [1], weight_f: [1, 1], value: [1, 2, 3, 4],
...
const BNP = {
	...
	title_m: "BNP (ng/L)", btnText_m:  ["< 50", "50-199", "200-800", "> 800"],
	title_c: "", btnText_c: [],
	title_p: "", btnText_p: []
};
params.push(BNP);
...
// Set group titles
const groupTitle = {
	Cardiopulmonary: "Cardiopulmonary excercise testing", Biochem: "Biochemical markers",
...
function updateRisk() {
	...
	for (let i = 0; i < numOfRisks; i++) {
		...
		if (riskValue[i] && paramCount[i] >= paramMin) {
			const riskRate = ["&nbsp;<small>(Low)</small>", "&nbsp;<small>(Interm.-Low)</small>", "&nbsp;<small>(Interm.-High)</small>", "&nbsp;<small>(High)</small>"];
